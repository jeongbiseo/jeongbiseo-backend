...
public class AuthController {
	...
	/**
	 * logOut: POST /api/v1/auth/logout Bearer 토큰 주입 검증이 필요한 인증 봉투 대상 API
	 */
	@PostMapping("/logout")
	public ResponseEntity<CustomResponse<String>> logOut(@RequestAttribute("memberId") String memberId // FixedMemberResolver
																										// 또는
																										// JWT
																										// 인터셉터
																										// 공급
