...
public class AuthService {
	...
	public String getAuthorizeUrl(String provider) {
		...
		if ("kakao".equals(provider)) {
			return "https://kauth.kakao.com/oauth/authorize?client_id=DUMMY&redirect_uri=DUMMY&response_type=code&state="
					+ state;
		}
		return "https://accounts.google.com/o/oauth2/v2/auth?client_id=DUMMY&redirect_uri=DUMMY&response_type=code&scope=email profile&state="
				+ state;
	}
