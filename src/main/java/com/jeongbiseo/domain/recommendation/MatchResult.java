...
public record MatchResult(Long subsidyId, boolean regionDemoted, boolean matched, int matchScore,
		int confirmedMatchCount, Integer confirmedAgeMin, Integer confirmedAgeMax,
		List<EligibilityReason> uncomputableReasons, LocalDate deadline, String sourceId, String externalId) {
